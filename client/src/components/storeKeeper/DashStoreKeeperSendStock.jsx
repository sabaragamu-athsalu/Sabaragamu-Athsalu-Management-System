...
export default function DashStoreKeeperSendStock() {
      ...
      try {
        ...
        if (storeIdRes.ok) {
          ...
          const productsRes = await fetch(
            `/api/store-item/getstoreitems/${storeIdData.stores[0].storeId}`
          );
        ...
        //setStoreId(storeIdData.shops[0]);
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log(storeId, formData.shopId, selectedProduct.itemId);
    try {
      const res = await fetch(
        `/api/store-item/senditem/${storeId}/${formData.shopId}/${selectedProduct.itemId}`,
        {
          method: "PUT",
          headers: {
                          ...
                          <TableCell>
                            <Button
                              onClick={() => {
                                ...
                                setSendItemId(product.itemId); //undefined value comes
                              }}
